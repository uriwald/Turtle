...
//----------------------------------------------------------------------
{
    ...
    //----------------------------------------------------------------------
    {
        ...
        throw __("Don't know about variable") + " "+ name;
    };
    ...
    //----------------------------------------------------------------------
    {
        ...
        if (!procedure) {
            ...
            {
                throw __("Don't know how to") + " "+ name;
            }
            else
            {
                var func = function() {
    ...
    self.routines["to"] = function(list) {
        ...
        if (typeof self.routines[name] !== 'undefined' && self.routines[name].primitive) {
            throw __("Please don't try to override primitive functions");
        }
        name = name.toLowerCase();
        ...
        while (list.length) {
            var atom = list.shift();
            if (Type(atom) === 'word' && (atom === 'end' || atom === __('end'))) {
                break;
            }
    ...
    self.routines["apply"] = function(procname, list) {
        ...
        if (!routine) {
            throw __("Don't know how to") + " "+ procname;
        }
        if (routine.special) {
    ...
    Object.keys(self.routines).forEach(function(x) {
        self.routines[__(x)] = self.routines[x];
