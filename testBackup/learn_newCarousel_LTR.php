...
?>
        ...
        ?>
            ...
            <div id="header" >
                <div id="headprev" style="width: 30px; float: left"></div>
                <div id="headcar"  style="width: 910px; float: left; "></div> <!--direction: rtl;-->
                <div id="headnext" style="width: 30px; float: left"></div>
                <div id="progress">
                <div id="logoer"> 
                    <div id="display"> 
