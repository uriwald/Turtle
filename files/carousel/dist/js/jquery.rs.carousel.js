    ...
    $.widget('rs.carousel', {
        ...
        _slide: function (e, silent) {
            if ($('html').attr('dir') == 'rtl'){
                ...
                page = this.getPage(),
                pos = rtlWidth - page.first().position()[this.isHorizontal ? 'left' : 'top'],
                eventNamespace = this.eventNamespace,
                fullName = this.widgetFullName,
                transitionEndEvent;    
            }
            ...
            if (this.options.translate3d) {
                ...
                if ($('html').attr('dir') == 'rtl'){
                   animateProps[this.isHorizontal ? 'right' : 'top'] = -pos; 
                }
                else
        ...
        _getAbsoluteLastPos: function () {
            ...
            if (this.options.whitespace) {
             ...
             if ($('html').attr('dir') == 'rtl'){
                ...
                lastItemPos = lastItem.position()[this.isHorizontal ? 'right' : 'top'],
        ...
        destroy: function () {
            ...
            if (this.maskAdded) {
             ...
             if ($('html').attr('dir') == 'rtl'){
                cssProps[this.isHorizontal ? 'right' : 'top'] = '';
             }
             else
