...
<html>
    <head>
        ...
        $dd = new loadDd($rootDir, $env, "files/dd/");
        $jq = new loadJq($rootDir, $env);
        $bs = new loadBs($rootDir, $env, "files/bootstrap/");
        $lt = new loadTurtle($locale, $rootDir, $env);
        $dd->loadFiles(true, true, false, true); /*  dd.js , dd.css , skin2.css , flags.css */
        //$jq->loadFiles(true, false, false, false, true, false, false); /*182 min.js , jquery-ui.min.js , alerts.js , tmpl.js , storage.js , custom.css */
...
<h2> <!--<img src='images/sample/icon1.png' alt=''/> --></h2>
        ...
        echo "?"; ?> <!--<img src='images/sample/icon2.png' alt=''/>--> </h2>
